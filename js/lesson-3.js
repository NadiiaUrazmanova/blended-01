...
// const result = data.flatMap((elem) => elem.values);
//     console.log(result);
...
// console.log(stringArray.toSorted((a, b) => a.localeCompare(b) - b.localeCompare(a)));
...
// const result = user.filter((elem) => elem.age > 20);
...
// console.log(numbers.reduce((sum, elem) => { return sum + elem }, 0));
